        			...
        			<div class="row h_blog_item">
        				<div class="col-lg-6">
							<div class="h_blog_img">
								<img class="img-fluid" src="img/8-EsKrimAngi-By-dessynat23.jpg" alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="h_blog_text">
								<div class="h_blog_text_inner left">
									<h4>Es Krim Angi</h4>
									<p>Lokasi: Jl. Karel Satsuit Tubun No. 8, Akcaya, Pontianak Selatan, Akcaya, Pontianak Sel., Kota Pontianak.
                                        <br/>Jam buka: setiap hari, 08.00 hingga 17.00 WIB
                                        <br/>Harga: Mulai dari 10,000 IDR hingga 25,000 IDR
                                    </p>
									<a class="main_btn2" href="#">Deskripsi</a>
								</div>
							</div>
						</div>
        			</div>
